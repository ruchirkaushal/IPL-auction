...
const MI = [
    ...
    P('mi-2', 'Bevon Jacobs', 'BAT', 'India', false, 20, 3567, 2, 18, 0, 1, false, 'MI'),
    P('mi-3', 'Shrijith Krishnan', 'WK', 'India', false, 20, 3570, 2, 12, 0, 1, false, 'MI'),
    P('mi-4', 'Surya Kumar Yadav', 'BAT', 'India', false, 180, 174, 125, 3615, 0, 5, true, 'MI', 8),
    P('mi-5', 'Robin Minz', 'WK', 'India', false, 20, 3103, 5, 38, 0, 1, false, 'MI'),
    ...
    P('mi-8', 'Mitchell Santner', 'AR', 'New Zealand', true, 50, 75, 15, 85, 12, 2, true, 'MI'),
    P('mi-9', 'Naman Dhir', 'AR', 'India', false, 30, 3107, 8, 125, 2, 2, false, 'MI'),
    P('mi-10', 'Raj Angad Bawa', 'AR', 'India', false, 20, 781, 5, 28, 4, 1, false, 'MI'),
    ...
    P('mi-13', 'Reece Topley', 'BOWL', 'England', true, 40, 574, 5, 3, 6, 2, true, 'MI'),
    P('mi-14', 'Karn Sharma', 'BOWL', 'India', false, 30, 98, 58, 115, 45, 2, true, 'MI'),
    P('mi-15', 'Arjun Tendulkar', 'BOWL', 'India', false, 20, 585, 5, 12, 3, 1, false, 'MI'),
    P('mi-16', 'Ashwani Kumar', 'BOWL', 'India', false, 20, 3569, 2, 5, 2, 1, false, 'MI'),
    P('mi-17', 'Deepak Chahar', 'BOWL', 'India', false, 100, 91, 82, 185, 82, 3, true, 'MI'),
    P('mi-18', 'V. Satyanarayana Penmetsa', 'BOWL', 'India', false, 20, 3568, 1, 2, 1, 1, false, 'MI'),
    P('mi-19', 'Mujeeb-ur-Rahman', 'BOWL', 'Afghanistan', true, 30, 134, 20, 15, 18, 2, true, 'MI'),
    P('mi-20', 'Raghu Sharma', 'BOWL', 'India', false, 20, 3869, 1, 2, 1, 1, false, 'MI'),
    P('mi-21', 'Charith Asalanka', 'BOWL', 'Sri Lanka', true, 50, 605, 3, 35, 2, 2, true, 'MI'),
...
const PBKS = [
    P('pbks-1', 'Harnoor Pannu', 'BAT', 'India', false, 20, 784, 3, 22, 0, 1, false, 'PBKS'),
    P('pbks-2', 'Josh Inglis', 'WK', 'Australia', true, 60, 647, 5, 72, 0, 2, true, 'PBKS'),
    P('pbks-3', 'Pyla Avinash', 'BAT', 'India', false, 20, 3573, 2, 15, 0, 1, false, 'PBKS'),
    P('pbks-4', 'Shreyas Iyer', 'BAT', 'India', false, 200, 12, 118, 3540, 0, 5, true, 'PBKS', 1),
    P('pbks-5', 'Vishnu Vinod', 'WK', 'India', false, 20, 581, 12, 85, 0, 1, false, 'PBKS'),
    ...
    P('pbks-8', 'Shashank Singh', 'BAT', 'India', false, 40, 191, 32, 425, 2, 2, true, 'PBKS'),
    P('pbks-9', 'Azmatullah Omarzai', 'AR', 'Afghanistan', true, 50, 1354, 8, 95, 8, 2, true, 'PBKS'),
    P('pbks-10', 'Aaron Hardie', 'AR', 'Australia', true, 40, 2704, 5, 52, 5, 2, true, 'PBKS'),
    ...
    P('pbks-13', 'Suryansh Shedge', 'AR', 'India', false, 20, 2146, 3, 32, 1, 1, false, 'PBKS'),
    P('pbks-14', 'Harpreet Brar', 'AR', 'India', false, 40, 0, 32, 145, 28, 2, false, 'PBKS'),
    P('pbks-15', 'Priyansh Arya', 'AR', 'India', false, 20, 3571, 5, 48, 2, 1, false, 'PBKS'),
    ...
    P('pbks-21', 'Xavier Bartlett', 'BOWL', 'Australia', true, 40, 3572, 3, 5, 4, 1, true, 'PBKS'),
    P('pbks-22', 'Arshdeep Singh', 'BOWL', 'India', false, 130, 125, 68, 32, 82, 4, true, 'PBKS', 1),
    P('pbks-23', 'Pravin Dubey', 'BOWL', 'India', false, 20, 548, 8, 15, 5, 1, false, 'PBKS'),
    P('pbks-24', 'Yuzvendra Chahal', 'BOWL', 'India', false, 130, 10, 142, 115, 166, 5, true, 'PBKS', 2),
    P('pbks-25', 'Kyle Jamieson', 'BOWL', 'New Zealand', true, 50, 382, 8, 48, 10, 2, true, 'PBKS'),
];
exports.PBKS = PBKS;
