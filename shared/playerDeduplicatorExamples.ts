...
const test1ImageDetection = (): void => {
  console.log('\n╔════════════════════════════════════════════════════════════════════════════╗');
  ...
  testCases.forEach((testCase, idx) => {
    const result = hasValidImage(testCase.url as string | null | undefined);
...
const test2CompletenessScore = (): void => {
  console.log('\n╔════════════════════════════════════════════════════════════════════════════╗');
  ...
  const minimalScore = calculateCompletenessScore(minimalist);
  const completeScore = calculateCompletenessScore(complete);
...
const test3Case1ImagePriority = (): void => {
  console.log('\n╔════════════════════════════════════════════════════════════════════════════╗');
  ...
  const entryWithImage: Player & { originalIndex: number } = {
    ...createMockPlayer({
      id: 'kyle-1',
      name: 'Kyle Jamieson',
      country: 'New Zealand',
  ...
  const entryWithoutImage: Player & { originalIndex: number } = {
    ...createMockPlayer({
      id: 'kyle-2',
      name: 'Kyle Jamieson',
      country: 'New Zealand',
  ...
  const selected = selectCanonicalEntry([entryWithImage, entryWithoutImage]);
...
const test4RealDatabaseSimulation = (): void => {
  ...
  const report = deduplicateDatabase(miniDatabase);
